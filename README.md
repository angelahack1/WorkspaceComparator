...
<p align="center">
  <img src="https://img.shields.io/badge/VERSION-V1.5.0-4b8bf5?style=for-the-badge&labelColor=2b2d31" alt="Version v1.5.0">
...
- 🧾 **No silent drops** — every scanned file is accounted for. Unsupported or excluded files stay visible in a dark-gray **Ignored Files** section instead of disappearing.
...
This opens a real visible Chromium window, creates a 210-file dataset, and proves
the results table shows matched, unmatched, unsupported, excluded, dot-directory,
extensionless, and `.` / `..` ignored rows.
